...
var config = {
		spotify: {
			id: '202ad02f754a4b95bcdafd72f695a29b',
			redirect_uri:'http://savemyfriend.app:8080/callback.html',
			scope:'user-read-private playlist-read-private playlist-modify-private playlist-modify-public user-follow-read'
		}
}
...
var SpotifyController = require('./spotifyCtrl');
 

app.controller('spotifyCtrl', ['$scope', '$http', 'Spotify', SpotifyController]);
 


}).call(this,require("b55mWE"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_7aa570ba.js","/")
},{"./config":5,"./spotifyCtrl":7,"b55mWE":3,"buffer":2}],7:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var spotifyCtrl = function($scope,$http,Spotify) {
...
}).call(this,require("b55mWE"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/spotifyCtrl.js","/")
},{"b55mWE":3,"buffer":2}]},{},[6])